# data_check.py – Illumina Run Completeness Verification Script

`data_check.py` is a new, single source of truth script for validating the presence of expected file content within Illumina (NovaSeq & NextSeq) runfolders. It replaces the older checksum-based helpers and is
...
```bash
python3 data_check.py /media/data1/share/251204_A01229_0641_AHGCTNDRX7
```
